...
extends Screen {
    ...
    protected void init() {
        ...
        this.addDrawableChild(this.a);
        this.d = ButtonWidget.builder((Text)Text.literal((String)"LOGIN"), button -> this.a()).dimensions(n - 150, n2 + 30, 300, 40).build();
        this.addDrawableChild(this.d);
    }
    ...
    private void a() {
        ...
        com.vengeance.vengeanceclient.utils.p.za.b().a(string, new com.vengeance.vengeanceclient.utils.p.za.za$Callback(){
