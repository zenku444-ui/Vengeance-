...
extends zb {
    ...
    private void onAttackEvent(com.vengeance.vengeanceclient.p.p.s.zb zb2) {
        ...
        if (zi.a.crosshairTarget.getType() != HitResult.Type.ENTITY) {
            return;
        }
        ...
        Entity entity = class_39662.getEntity();
        if (!(entity instanceof EndCrystalEntity)) {
            return;
        }
        EndCrystalEntity class_15112 = (EndCrystalEntity)entity;
        ...
        class_15112.setRemoved(Entity.RemovalReason.KILLED);
