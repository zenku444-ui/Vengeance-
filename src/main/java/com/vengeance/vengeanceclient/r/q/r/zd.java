...
extends zb {
    ...
    private void o() {
        ...
        ItemStack class_17992 = focusedSlot.getStack();
        ...
        if (this.h.a(l, true)) {
            ...
            if (bl2) {
                zd.a.interactionManager.clickSlot(zd.a.player.currentScreenHandler.syncId, focusedSlot.getIndex(), 40, SlotActionType.SWAP, (PlayerEntity)zd.a.player);
            } else {
                zd.a.interactionManager.clickSlot(zd.a.player.currentScreenHandler.syncId, focusedSlot.getIndex(), 0, SlotActionType.QUICK_MOVE, (PlayerEntity)zd.a.player);
            }
        }
    }
