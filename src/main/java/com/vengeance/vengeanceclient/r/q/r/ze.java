...
extends zb {
    ...
    private void onMouseClick(com.vengeance.vengeanceclient.p.p.q.zb zb2) {
        if (zb2.a() == 2 && zb2.b() == 1) {
            ...
            if (ItemStackParticleEffect != null && ItemStackParticleEffect.getType() == HitResult.Type.ENTITY && (class_12972 = (class_39662 = (EntityHitResult)ItemStackParticleEffect).getEntity()) instanceof PlayerEntity) {
