...
extends zb {
    ...
    private List<Vec3d> c(ItemStack class_17992) {
        ...
        for (int i = 0; i < n; ++i) {
            ...
            if (ItemStackParticleEffect != null && ItemStackParticleEffect.getType() != HitResult.Type.MISS) {
    ...
    private HitResult a(Vec3d VanillaChestLootTableGenerator, Vec3d WallPlayerSkullBlock) {
        double d;
        BlockHitResult class_39652 = zq.a.world.raycast(new RaycastContext(VanillaChestLootTableGenerator, WallPlayerSkullBlock, RaycastContext.ShapeType.COLLIDER, RaycastContext.FluidHandling.NONE, (Entity)zq.a.player));
