...
implements zb {
    ...
    public static void a(Text class_25612) {
        za.a(class_25612.copy().withColor(za$Color.a.a()), true);
    }
    ...
    public static void b(Text class_25612) {
        ...
        za.a(class_25612.copy().withColor(za$Color.b.a()), true);
    }
    ...
    public static void c(Text class_25612) {
        ...
        za.a(class_25612.copy().withColor(za$Color.c.a()), true);
    }
    ...
    public enum za$Color {
        a(Color.GREEN), b(Color.ORANGE), c(Color.RED);
        private final int d;
        private final String e;

        private za$Color(Color color) {
            this.d = color.getRGB();
