...
extends zb {
    ...
    private void onRender3D(com.vengeance.vengeanceclient.p.p.t.zb zb2) {
        ...
        if (za.a.crosshairTarget != null && za.a.crosshairTarget.getType() == HitResult.class_240.BLOCK && za.a.options.attackKey.isPressed()) {
            return;
        }
        if (this.i.b() && za.a.crosshairTarget != null && za.a.crosshairTarget.getType() == HitResult.class_240.BLOCK) {
            return;
        }
        this.k = this.n();
        if (this.k != null) {
