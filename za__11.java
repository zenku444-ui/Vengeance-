...
extends zb {
    ...
    private boolean n() {
        ...
        ItemStackParticleEffect = class_39652.getBlockPos().offset(class_39652.getSide());
        return za.a.world != null && za.a.player != null && za.a.player.getEntityPos().distanceTo(ItemStackParticleEffect.toCenterPos()) <= 4.5 && za.a.world.getBlockState((BlockPos)ItemStackParticleEffect).isAir() && this.a(Items.RAIL) && this.a(Items.TNT_MINECART);
    }
