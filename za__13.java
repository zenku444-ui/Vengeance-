...
extends zb {
    private static final List<za> b = Arrays.asList(new za(Items.DIAMOND_SWORD, Items.DIAMOND, 2, Items.STICK, 1, new int[]{-1, 1, -1, -1, 1, -1, -1, 2, -1}), new za(Items.DIAMOND_PICKAXE, Items.DIAMOND, 3, Items.STICK, 2, new int[]{1, 1, 1, -1, 2, -1, -1, 2, -1}), new za(Items.DIAMOND_AXE, Items.DIAMOND, 3, Items.STICK, 2, new int[]{1, 1, -1, 1, 2, -1, -1, 2, -1}), new za(Items.DIAMOND_SHOVEL, Items.DIAMOND, 1, Items.STICK, 2, new int[]{-1, 1, -1, -1, 2, -1, -1, 2, -1}), new za(Items.IRON_SWORD, Items.IRON_INGOT, 2, Items.STICK, 1, new int[]{-1, 1, -1, -1, 1, -1, -1, 2, -1}), new za(Items.IRON_PICKAXE, Items.IRON_INGOT, 3, Items.STICK, 2, new int[]{1, 1, 1, -1, 2, -1, -1, 2, -1}), new za(Items.IRON_AXE, Items.IRON_INGOT, 3, Items.STICK, 2, new int[]{1, 1, -1, 1, 2, -1, -1, 2, -1}), new za(Items.IRON_SHOVEL, Items.IRON_INGOT, 1, Items.STICK, 2, new int[]{-1, 1, -1, -1, 2, -1, -1, 2, -1}), new za(Items.GOLDEN_SWORD, Items.GOLD_INGOT, 2, Items.STICK, 1, new int[]{-1, 1, -1, -1, 1, -1, -1, 2, -1}), new za(Items.GOLDEN_PICKAXE, Items.GOLD_INGOT, 3, Items.STICK, 2, new int[]{1, 1, 1, -1, 2, -1, -1, 2, -1}), new za(Items.GOLDEN_AXE, Items.GOLD_INGOT, 3, Items.STICK, 2, new int[]{1, 1, -1, 1, 2, -1, -1, 2, -1}), new za(Items.GOLDEN_SHOVEL, Items.GOLD_INGOT, 1, Items.STICK, 2, new int[]{-1, 1, -1, -1, 2, -1, -1, 2, -1}), new za(Items.WOODEN_SWORD, Items.OAK_PLANKS, 2, Items.STICK, 1, new int[]{-1, 1, -1, -1, 1, -1, -1, 2, -1}), new za(Items.WOODEN_PICKAXE, Items.OAK_PLANKS, 3, Items.STICK, 2, new int[]{1, 1, 1, -1, 2, -1, -1, 2, -1}), new za(Items.WOODEN_AXE, Items.OAK_PLANKS, 3, Items.STICK, 2, new int[]{1, 1, -1, 1, 2, -1, -1, 2, -1}), new za(Items.WOODEN_SHOVEL, Items.OAK_PLANKS, 1, Items.STICK, 2, new int[]{-1, 1, -1, -1, 2, -1, -1, 2, -1}), new za(Items.DIAMOND_HELMET, Items.DIAMOND, 5, new int[]{1, 1, 1, 1, -1, 1, -1, -1, -1}), new za(Items.DIAMOND_CHESTPLATE, Items.DIAMOND, 8, new int[]{1, -1, 1, 1, 1, 1, 1, 1, 1}), new za(Items.DIAMOND_LEGGINGS, Items.DIAMOND, 7, new int[]{1, 1, 1, 1, -1, 1, 1, -1, 1}), new za(Items.DIAMOND_BOOTS, Items.DIAMOND, 4, new int[]{-1, -1, -1, 1, -1, 1, 1, -1, 1}), new za(Items.IRON_HELMET, Items.IRON_INGOT, 5, new int[]{1, 1, 1, 1, -1, 1, -1, -1, -1}), new za(Items.IRON_CHESTPLATE, Items.IRON_INGOT, 8, new int[]{1, -1, 1, 1, 1, 1, 1, 1, 1}), new za(Items.IRON_LEGGINGS, Items.IRON_INGOT, 7, new int[]{1, 1, 1, 1, -1, 1, 1, -1, 1}), new za(Items.IRON_BOOTS, Items.IRON_INGOT, 4, new int[]{-1, -1, -1, 1, -1, 1, 1, -1, 1}), new za(Items.GOLDEN_HELMET, Items.GOLD_INGOT, 5, new int[]{1, 1, 1, 1, -1, 1, -1, -1, -1}), new za(Items.GOLDEN_CHESTPLATE, Items.GOLD_INGOT, 8, new int[]{1, -1, 1, 1, 1, 1, 1, 1, 1}), new za(Items.GOLDEN_LEGGINGS, Items.GOLD_INGOT, 7, new int[]{1, 1, 1, 1, -1, 1, 1, -1, 1}), new za(Items.GOLDEN_BOOTS, Items.GOLD_INGOT, 4, new int[]{-1, -1, -1, 1, -1, 1, 1, -1, 1}), new za(Items.LEATHER_HELMET, Items.LEATHER, 5, new int[]{1, 1, 1, 1, -1, 1, -1, -1, -1}), new za(Items.LEATHER_CHESTPLATE, Items.LEATHER, 8, new int[]{1, -1, 1, 1, 1, 1, 1, 1, 1}), new za(Items.LEATHER_LEGGINGS, Items.LEATHER, 7, new int[]{1, 1, 1, 1, -1, 1, 1, -1, 1}), new za(Items.LEATHER_BOOTS, Items.LEATHER, 4, new int[]{-1, -1, -1, 1, -1, 1, 1, -1, 1}), new za(Items.GOLDEN_APPLE, Items.GOLD_INGOT, 8, Items.APPLE, 1, new int[]{1, 1, 1, 1, 2, 1, 1, 1, 1}));
    ...
    private record za(Item a, Item b, int c, Item d, int e, int[] f) {
        za(Item class_17922, Item class_17923, int n, int[] nArray) {
