...
extends com.vengeance.vengeanceclient.r.zb {
    ...
    private void a(List<com.vengeance.vengeanceclient.r.zb> list) {
        ...
        for (int i = 0; i < list.size(); ++i) {
            za za2 = new za(this, list, i, zb2);
            this.a(za2, zb2);
        }
    }

    private void a(za za2, zb zb2) {
        this.b(za2, zb2);
        this.d(za2, zb2);
        this.e(za2, zb2);
        zb2.h += za2.e;
    ...
    private class za {
        ...
        za(za za2, List<com.vengeance.vengeanceclient.r.zb> list, int n, zb zb2) {
