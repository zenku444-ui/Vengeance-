...
implements Closeable {
    ...
    public void a(MatrixStack class_45872, String string, float f, float f2, Color color) {
        ...
        for (int i = 0; i < cArray.length; ++i) {
            ...
            if (bl) {
                ...
                if (a.containsKey(c2)) {
                    int n2 = a.get(c2);
                    object2 = com.vengeance.vengeanceclient.utils.w.q.q.zb.c(n2);
                    f7 = (float)object2[0] / 255.0f;
                    f8 = (float)object2[1] / 255.0f;
                    f9 = (float)object2[2] / 255.0f;
                    continue;
                }
                if (c2 != 'R') continue;
                f7 = f3;
            ...
            if (zb2.e() != ' ') {
                ...
                object2 = new za(f10, f11, f7, f8, f9, zb2);
    ...
    record za(float a, float b, float c, float d, float e, zb f) {
        @Override
        @NotNull
        ...
        public final int hashCode() {
            return (int)ObjectMethods.bootstrap("hashCode", new MethodHandle[]{za.class, "atX;atY;r;g;b;toDraw", "a", "b", "c", "d", "e", "f"}, this);
        }

        @Override
        public final boolean equals(Object object) {
            return (boolean)ObjectMethods.bootstrap("equals", new MethodHandle[]{za.class, "atX;atY;r;g;b;toDraw", "a", "b", "c", "d", "e", "f"}, this, object);
        }
    }
}
