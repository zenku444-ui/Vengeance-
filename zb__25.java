...
implements zc {
    ...
    private final com.vengeance.vengeanceclient.utils.w.s.r.zb c;
    private final za d;
    ...
    public void a(Matrix4f matrix4f, float f, float f2, float f3) {
        ...
        zb.a(class_2872, matrix4f, f, f2, f3, f4, f5, this.d.a(), this.d.b(), this.d.c(), this.d.d());
    ...
    public final String toString() {
        return ObjectMethods.bootstrap("toString", new MethodHandle[]{zb.class, "size;radius;color;smoothness", "b", "c", "d", "e"}, this);
    }

    @Override
    public final int hashCode() {
        return (int)ObjectMethods.bootstrap("hashCode", new MethodHandle[]{zb.class, "size;radius;color;smoothness", "b", "c", "d", "e"}, this);
    }

    @Override
    public final boolean equals(Object object) {
        return (boolean)ObjectMethods.bootstrap("equals", new MethodHandle[]{zb.class, "size;radius;color;smoothness", "b", "c", "d", "e"}, this, object);
    }
