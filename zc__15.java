...
extends MatrixStack {
    ...
    public MatrixStack.class_4665 peek() {
        if (!this.b) {
            return super.peek();
        }
        try {
            return a.invoke(this.d.a, this.d.b);
        }
    ...
    static {
        ...
        try {
            MethodHandles.Lookup lookup = MethodHandles.privateLookupIn(MatrixStack.class_4665.class, MethodHandles.lookup());
            methodHandle = lookup.findConstructor(MatrixStack.class_4665.class, MethodType.methodType(Void.TYPE, Matrix4f.class, Matrix3f.class));
        }
        catch (Throwable throwable) {
            // empty catch block
        }
