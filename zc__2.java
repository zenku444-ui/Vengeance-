...
extends Screen {
    ...
    private void g() {
        try {
            ...
            if (this.client.getNetworkHandler() != null && (string = this.client.getNetworkHandler().getPlayerListEntry(this.client.player.getUuid())) != null && string.getSkinTextures() != null && string.getSkinTextures().comp_1626() != null) {
                class_29602 = string.getSkinTextures().comp_1626().comp_3627();
            }
            if (class_29602 == null) {
                class_29602 = DefaultSkinHelper.getSkinTextures((UUID)this.client.player.getUuid()).comp_1626().comp_3627();
            }
            if (class_29602 == null) {
                return;
            }
    ...
    public boolean mouseClicked(Click class_119092, boolean bl) {
        double d = class_119092.comp_4798();
    ...
    public boolean mouseDragged(Click class_119092, double d, double d2) {
        double d3 = class_119092.comp_4798();
        double d4 = class_119092.comp_4799();
        float f = this.b(this.bb) * this.h();
        int n = this.width / 2;
    ...
    public boolean charTyped(CharInput class_119052) {
        char c = (char)class_119052.comp_4793();
        int n = class_119052.comp_4794();
        if (this.bk) {
    ...
    public boolean keyPressed(KeyInput class_119082) {
        int n = class_119082.comp_4795();
        int n2 = class_119082.comp_4796();
        int n3 = class_119082.comp_4797();
        if (this.bk) {
            if (n == 259) {
                if (!this.bl.isEmpty()) {
