...
extends zb {
    ...
    public void onTick(com.vengeance.vengeanceclient.p.p.q.za za2) {
        ...
        if ((bl = zx.a.options.attackKey.isPressed()) && !this.f) {
            ...
            if (!(bl2 || bl3 || bl4 || (ItemStackParticleEffect = zx.a.crosshairTarget) == null || ItemStackParticleEffect.getType() != HitResult.class_240.ENTITY || (class_12972 = ((EntityHitResult)ItemStackParticleEffect).getEntity()) == null || class_12972 instanceof EndCrystalEntity || (n = this.n()) == -1)) {
