...
extends zb {
    ...
    public void onTick(com.vengeance.vengeanceclient.p.p.q.za za2) {
        ...
        if ((bl = zz.a.options.attackKey.isPressed()) && !this.f && zz.a.player.getMainHandStack().getItem() == Items.TOTEM_OF_UNDYING && (ItemStackParticleEffect = zz.a.crosshairTarget) != null && ItemStackParticleEffect.getType() == HitResult.class_240.ENTITY && (class_12972 = ((EntityHitResult)ItemStackParticleEffect).getEntity()) != null && (n = this.n()) != -1) {
